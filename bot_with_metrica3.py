...
async def main():
    ...
    # ПРИНУДИТЕЛЬНОЕ СОЗДАНИЕ JOBQUEUE (как в рабочем коде)
    ...
    application.add_handler(CallbackQueryHandler(lambda u, c: u.answer(), pattern="^show_invite_code$"))  # <-- ДОБАВЛЕНО
